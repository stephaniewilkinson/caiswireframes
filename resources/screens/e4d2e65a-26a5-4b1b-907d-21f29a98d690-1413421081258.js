jQuery("#simulation")
  .on("mouseenter dragenter", ".s-e4d2e65a-26a5-4b1b-907d-21f29a98d690 .mouseenter", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-e4d2e65a-26a5-4b1b-907d-21f29a98d690 #s-Label_32": {
                      "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-e4d2e65a-26a5-4b1b-907d-21f29a98d690 #s-Label_33": {
                      "attributes": {
                        "background-color": "#EEEEEE",
                        "background-image": "none",
                        "border-top-width": "1px",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-e4d2e65a-26a5-4b1b-907d-21f29a98d690 #s-Label_35": {
                      "attributes": {
                        "background-color": "#EEEEEE",
                        "background-image": "none",
                        "border-top-width": "1px",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-e4d2e65a-26a5-4b1b-907d-21f29a98d690 #s-Label_36": {
                      "attributes": {
                        "background-color": "#EEEEEE",
                        "background-image": "none",
                        "border-top-width": "1px",
  ...
  .on("mouseleave dragleave", ".s-e4d2e65a-26a5-4b1b-907d-21f29a98d690 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
