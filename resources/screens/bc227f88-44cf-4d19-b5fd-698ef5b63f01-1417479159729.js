jQuery("#simulation")
  .on("mouseenter dragenter", ".s-bc227f88-44cf-4d19-b5fd-698ef5b63f01 .mouseenter", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-bc227f88-44cf-4d19-b5fd-698ef5b63f01 #s-Label_32": {
                      "attributes": {
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-bc227f88-44cf-4d19-b5fd-698ef5b63f01 #s-Label_33": {
                      "attributes": {
                        "background-color": "#EEEEEE",
                        "background-image": "none",
                        "border-top-width": "1px",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-bc227f88-44cf-4d19-b5fd-698ef5b63f01 #s-Label_35": {
                      "attributes": {
                        "background-color": "#EEEEEE",
                        "background-image": "none",
                        "border-top-width": "1px",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-bc227f88-44cf-4d19-b5fd-698ef5b63f01 #s-Label_36": {
                      "attributes": {
                        "background-color": "#EEEEEE",
                        "background-image": "none",
                        "border-top-width": "1px",
  ...
  .on("mouseleave dragleave", ".s-bc227f88-44cf-4d19-b5fd-698ef5b63f01 .mouseleave", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getDirectEventFirer(this);
